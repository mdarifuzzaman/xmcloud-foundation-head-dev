...
export const Search_PreviewSearchComponent = ({ defaultItemsPerPage = 6, ...rest }: PreviewSearchProps) => {
      ...
      <PreviewSearch.Root data-control="PreviewSearch.Root">
        <FormControl
          onSubmit={(e: SyntheticEvent): void => {
            e.preventDefault();
            // @ts-expect-error: this is because some issues
...
const PreviewSearchInputWidget = widget(Search_PreviewSearchComponent, WidgetDataType.PREVIEW_SEARCH, 'content');
