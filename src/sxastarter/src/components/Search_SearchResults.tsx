...
import QuerySummary from './Search_QuerySummary';
import SearchFacets from './Search_SearchFacets';
import SearchPagination from './Search_SearchPagination';
import SearchSort from './Search_SearchSort';
import Search_Loader from './Search_Loader';
import { getColorScheme } from 'lib/search';
...
export const SearchResults = (props: InitialSearchProps) => {
  ...
  console.log("indexSources", indexSources);
  console.log("InitialSearchProps", props);
...
const Search_SearchResultsWidget = widget(SearchResults, WidgetDataType.SEARCH_RESULTS, 'content');
export default Search_SearchResultsWidget;